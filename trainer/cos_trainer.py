...
class CosTrainer(AbsTrainer):
    def __init__(self, model, tr_data, cv_data, optim, config, args, device, loss_fn, *args_, **kwargs):
        super().__init__(model, tr_data, cv_data, optim, config, args, device, loss_fn, *args_, **kwargs)
